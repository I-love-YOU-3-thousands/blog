<template>
  ...
  <div
    class="articlelist"
    :class="{ grid: listview === 'grid', list: listview === 'list' }"
  >
    <div class="acontent">
      <div class="main">
        <div class="cover">
        ...
        <div class="msg">
          <div class="title">
            <a :href="withBase(article.relativePath)" class="a">
              <span class="cats" v-if="article.frontmatter?.categories">
                <span
                  class="cat"
                  v-for="item in article.frontmatter.categories.slice(0, 2)"
                  >{{ item }}</span
                >
                <span
                  class="cat"
                  v-if="article.frontmatter.categories.length > 2"
                  >...</span
                >
              </span>
          ...
          <div class="meta">
            <ArticleMetadata :article="article" type="card" />
          </div>
        </div>
      </div>
    </div>
...
.articlelist.list {
  ...
  .main {
    ...
    .cover {
      ...
      overflow: hidden;
      box-shadow: rgba(61, 72, 83, 0.36) 0px 0px 1px,
