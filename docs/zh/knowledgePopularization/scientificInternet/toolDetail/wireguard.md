...
![](/scientificInternet/wireguard/wireguard-01.png)
...
![](/scientificInternet/wireguard/ios/ios-01.png)

提示添加VPN配置，允许

![](/scientificInternet/wireguard/ios/ios-02.png)

我们需要获取配置文件后，才可以使用

![](/scientificInternet/wireguard/ios/ios-03.png)
...
![](/scientificInternet/wireguard/android/android-01.png)
...
![](/scientificInternet/wireguard/windows/windows-01.png)

点击安装包安装即可

![](/scientificInternet/wireguard/windows/windows-02.png)

桌面没有快捷方式，在开始 - 最近添加中找到 Wireguard - 右键 - 更多 - 打开文件位置

![](/scientificInternet/wireguard/windows/windows-03.png)

再次鼠标右键 - 发送到 - 桌面快捷方式

![](/scientificInternet/wireguard/windows/windows-04.png)
...
![](/scientificInternet/wireguard/ios/ios-04.png)

点 `/generate` ，提示我们需要加3个群组后方可使用

![](/scientificInternet/wireguard/ios/ios-05.png)

我们分别进入3个群组

![](/scientificInternet/wireguard/ios/ios-06.png)

然后点 `I have subscribed` 确认，后再次点 `/generate`

会获得一个无限流量的密钥及配置文件，点分享

![](/scientificInternet/wireguard/ios/ios-07.png)

选择 WireGuard 导入即可使用

![](/scientificInternet/wireguard/ios/ios-08.png)

打开开关，访问 [谷歌](https://www.google.com) 只能访问 [谷歌香港](https://www.google.com.hk) 

打不开也不要急，一会优选IP就可以了

![](/scientificInternet/wireguard/ios/ios-09.png)
...
![](/scientificInternet/wireguard/android/android-02.png)

点 `/generate` ，提示我们需要加3个群组后方可使用

![](/scientificInternet/wireguard/android/android-03.png)

我们分别进入3个群组

![](/scientificInternet/wireguard/android/android-04.png)
...
![](/scientificInternet/wireguard/android/android-05.png)

点击左下角上角 `+` ，`导入配置或压缩包`

在下载内容 - Telegram 文件夹，选择刚才的文件

![](/scientificInternet/wireguard/android/android-06.png)

导入成功后，打开开关看看，若无法成功访问

先关闭！！！我们优选IP后再来试！！

![](/scientificInternet/wireguard/android/android-07.png)
...
![](/scientificInternet/wireguard/windows/windows-05.png)

点 `/generate` ，提示我们需要加3个群组后方可使用

![](/scientificInternet/wireguard/windows/windows-06.png)

我们分别进入3个群组

![](/scientificInternet/wireguard/windows/windows-07.png)

然后点 `I have subscribed` 确认，后再次点 `/generate`

会获得一个无限流量的密钥及 `wg-config.conf` 配置文件

![](/scientificInternet/wireguard/windows/windows-08.png)

下载配置文件并打开文件夹

![](/scientificInternet/wireguard/windows/windows-09.png)

将这个文件拖到桌面，方便使用！

![](/scientificInternet/wireguard/windows/windows-10.png)

回到桌面打开 WireGuard ，点 `从文件导入隧道`

![](/scientificInternet/wireguard/windows/windows-11.png)

点击刚刚拖到桌面的 `wg-config.conf` 文件，打开

![](/scientificInternet/wireguard/windows/windows-12.png)

导入成功后就能看到公钥等信息，点击 `连接`

![](/scientificInternet/wireguard/windows/windows-13.png)

这样就连接成功了

![](/scientificInternet/wireguard/windows/windows-14.png)
...
![](/scientificInternet/wireguard/windows/windows-15.png)
...
![](/scientificInternet/wireguard/ios/ios-10.png)
...
![](/scientificInternet/wireguard/ios/ios-11.png)
...
![](/scientificInternet/wireguard/ios/ios-12.png)
...
![](/scientificInternet/wireguard/ios/ios-13.png)
...
![](/scientificInternet/wireguard/ios/ios-14.png)

进入 wireguard 点击刚才的配置，编辑

![](/scientificInternet/wireguard/ios/ios-15.png)
...
![](/scientificInternet/wireguard/ios/ios-16.png)
...
![](/scientificInternet/wireguard/android/android-08.png)
...
![](/scientificInternet/wireguard/android/android-09.png)
...
![](/scientificInternet/wireguard/android/android-10.png)
...
![](/scientificInternet/wireguard/android/android-11.png)

复制第1个IP+端口，点击 Wireguard 的配置文件

![](/scientificInternet/wireguard/android/android-12.png)

右上角 编辑，下拉到对端的位置

![](/scientificInternet/wireguard/android/android-13.png)
...
![](/scientificInternet/wireguard/android/android-14.png)

访问 [谷歌](https://www.google.com) 只能访问 [谷歌香港](https://www.google.com.hk) ，[油管](https://youtube.com) 也可以，不是很快，日常够用

![](/scientificInternet/wireguard/android/android-15.png)
...
![](/scientificInternet/wireguard/windows/windows-16.png)

这里我们输入 `1` ，回车

![](/scientificInternet/wireguard/windows/windows-17.png)

优选的结果自动生成了 `result.csv` 文件，按任意键退出

![](/scientificInternet/wireguard/windows/windows-18.png)

鼠标对着 `result.csv` 右键，用 `记事本打开`

![](/scientificInternet/wireguard/windows/windows-19.png)

打开 WireGuard 客户端，在刚才的wg-config配置中，点击 `编辑`

![](/scientificInternet/wireguard/windows/windows-20.png)
...
![](/scientificInternet/wireguard/windows/windows-21.png)
...
![](/scientificInternet/wireguard/wireguard-02.png)
...
![](/scientificInternet/wireguard/ios/ios-17.png)

等待配置生成

![](/scientificInternet/wireguard/ios/ios-18.png)


生成后将配置复制出来，等会要用

![](/scientificInternet/wireguard/ios/ios-19.png)
...
![](/scientificInternet/wireguard/ios/ios-20.png)
...
![](/scientificInternet/wireguard/ios/ios-21.png)
...
![](/scientificInternet/wireguard/ios/ios-22.png)
...
![](/scientificInternet/wireguard/android/android-16.png)
...
![](/scientificInternet/wireguard/android/android-17.png)
...
![](/scientificInternet/wireguard/android/android-18.png)

名称不要填中文，私钥需要点一下生成，会自动生成私钥和公钥

![](/scientificInternet/wireguard/android/android-19.png)
...
![](/scientificInternet/wireguard/android/android-20.png)
...
![](/scientificInternet/wireguard/android/android-21.png)

访问 [谷歌](https://www.google.com) 只能访问 [谷歌香港](https://www.google.com.hk)

[查看一下账户类型](#账户类型)，确定是warp普通账户了

![](/scientificInternet/wireguard/android/android-22.png)
...
![](/scientificInternet/wireguard/windows/windows-22.png)

解压到桌面

![](/scientificInternet/wireguard/windows/windows-23.png)

按住 `SHIFT键` 鼠标右键，选择 `在此处打开Powershell`

![](/scientificInternet/wireguard/windows/windows-24.png)
...
![](/scientificInternet/wireguard/windows/windows-25.png)
...
![](/scientificInternet/wireguard/windows/windows-26.png)
...
![](/scientificInternet/wireguard/windows/windows-27.png)
...
![](/scientificInternet/wireguard/windows/windows-28.png)

连接，好像是没有握手成功，[优选一下IP](#优选ip) 替换 `Endpoint` 对端即可

![](/scientificInternet/wireguard/windows/windows-29.png)

现在就可以了

![](/scientificInternet/wireguard/windows/windows-30.png)

[查看一下账户类型](#账户类型)，确定是warp普通账户了

![](/scientificInternet/wireguard/windows/windows-31.png)
