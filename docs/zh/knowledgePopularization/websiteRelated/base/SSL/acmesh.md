...
![](/websiteRelated/base/ssl/acmesh/acmesh-01.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-02.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-03.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-04.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-05.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-06.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-07.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-08.png)


输入 acme.sh 可以查看当前版本及使用命令

![](/websiteRelated/base/ssl/acmesh/acmesh-09.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-10.png)
...
acme.sh --info
```
![](/websiteRelated/base/ssl/acmesh/acmesh-11.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-12.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-13.png)
...
![](/websiteRelated/base/ssl/acmesh/webroot/webroot-01.png)
...
![](/websiteRelated/base/ssl/acmesh/standalone/standalone-01.png)
...
![](/websiteRelated/base/ssl/acmesh/standalone/standalone-02.png)
...
![](/websiteRelated/base/ssl/acmesh/alpn/alpn-01.png)
...
![](/websiteRelated/base/ssl/acmesh/alpn/alpn-02.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-01.png)

我的域名是腾讯旗下的 [DNSPod](https://dnspod.cn) ，我用它演示

![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-02.png)

在 [DnsPod后台](https://console.dnspod.cn/) - 用户 - API密钥 - DnsPod Token，创建密钥

![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-03.png)

名称随便输吧

![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-04.png)

这里的 `ID` 和 `Token` 分别复制，填入

注意！token只显示一次！

![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-05.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-06.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsapi/dnsapi-07.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsmanual/dnsmanual-01.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsmanual/dnsmanual-02.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsmanual/dnsmanual-03.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsmanual/dnsmanual-04.png)
...
![](/websiteRelated/base/ssl/acmesh/dnsalias/dnsalias-01.png)
...
![](/websiteRelated/base/ssl/acmesh/nginx/nginx-01.png)
...
![](/websiteRelated/base/ssl/acmesh/nginx/nginx-02.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-14.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-15.png)
...
![](/websiteRelated/base/ssl/acmesh/acmesh-16.png)
