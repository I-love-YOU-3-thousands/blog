...
![](/websiteRelated/static/pages/git/git-01.png)
...
![](/websiteRelated/static/pages/git/git-02.png)


安装的时候，这里要勾选

![](/websiteRelated/static/pages/git/git-03.png)


下载安装完成后 选择Launch Git Bash启动


![](/websiteRelated/static/pages/git/git-04.png)
...
![](/websiteRelated/static/pages/git/git-05.png)
...
![](/websiteRelated/static/pages/git/git-06.png)


![](/websiteRelated/static/pages/git/git-07.png)
...
![](/websiteRelated/static/pages/git/git-08.png)
...
![](/websiteRelated/static/pages/git/git-09.png)
...
![](/websiteRelated/static/pages/git/git-10.png)
...
git init
```
![](/websiteRelated/static/pages/git/git-11.png)


创建完成后会在本地生成一个 `.git` 的隐藏文件

![](/websiteRelated/static/pages/git/git-12.png)
...
![](/websiteRelated/static/pages/git/git-13.png)
:::
...
![](/websiteRelated/static/pages/git/git-14.png)
...
git checkout main
```
![](/websiteRelated/static/pages/git/git-15.png)
...
![](/websiteRelated/static/pages/git/git-16.png)
...
![](/websiteRelated/static/pages/git/git-17.png)
...
![](/websiteRelated/static/pages/git/git-18.png)


打开Github，右上角-头像-设置

![](/websiteRelated/static/pages/git/git-19.png)


点击 SSH与GPG公钥，创建New SSH key

![](/websiteRelated/static/pages/git/git-20.png)

标题随便起，key是刚刚生成的SSH key，全选了，复制粘贴进去

![](/websiteRelated/static/pages/git/git-21.png)


授权，输入你github的登录密码

![](/websiteRelated/static/pages/git/git-22.png)

SSH key就创建好了，邮箱也会收到通知

![](/websiteRelated/static/pages/git/git-23.png)

![](/websiteRelated/static/pages/git/git-24.png)
...
![](/websiteRelated/static/pages/git/git-25.png)
...
![](/websiteRelated/static/pages/git/git-26.png)
...
![](/websiteRelated/static/pages/git/git-27.png)
...
![](/websiteRelated/static/pages/git/git-28.png)
...
![](/websiteRelated/static/pages/git/git-29.png)
...
![](/websiteRelated/static/pages/git/git-30.png)
...
![](/websiteRelated/static/pages/git/git-31.png)
